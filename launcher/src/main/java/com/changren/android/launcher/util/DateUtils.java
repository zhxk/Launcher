...
public class DateUtils extends android.text.format.DateUtils {
     ...
     * @return
     */
    public static int[] getYMD(String date_str) {
        Date date = parseDate(date_str, "yyyy-MM-dd");
    ...
    public static int[] getYMD(Date date) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        return new int[]{cal.get(Calendar.YEAR),cal.get(Calendar.MONTH)+1,cal.get(Calendar.DATE),cal.get(Calendar.WEEK_OF_MONTH)};
    }
