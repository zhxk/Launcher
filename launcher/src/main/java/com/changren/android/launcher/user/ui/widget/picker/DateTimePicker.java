package com.changren.android.launcher.user.ui.widget.picker;
...
//        LogUtils.v(this, "change months and days while set selected");
...
//            LogUtils.v(this, "change months while set selected");
...
//            LogUtils.v(this, "init years before make view");
            initYearData();
        }
        if (dateMode != NONE && months.size() == 0) {
//            LogUtils.v(this, "init months before make view");
...
//            LogUtils.v(this, "init days before make view");
            int selectedYear;
            if (dateMode == YEAR_MONTH_DAY) {
...
//            LogUtils.v(this, "init hours before make view");
            initHourData();
        }
        if (timeMode != NONE && minutes.size() == 0) {
//            LogUtils.v(this, "init minutes before make view");
...
//                    LogUtils.v(this, "change months after year wheeled");
                    if (resetWhileWheel) {
        ...
        if (dateMode != NONE) {
            ...
            monthView.setOnItemSelectListener(new WheelView.OnItemSelectListener() {
                ...
                public void onSelected(int index) {
                    ...
                    if (dateMode == YEAR_MONTH_DAY || dateMode == MONTH_DAY) {
//                        LogUtils.v(this, "change days after month wheeled");
                        if (resetWhileWheel) {
                            selectedDayIndex = 0;//重置日子索引
                        }
                        int selectedYear;
        ...
        if (timeMode != NONE) {
            ...
            hourView.setOnItemSelectListener(new WheelView.OnItemSelectListener() {
                ...
                public void onSelected(int index) {
                    ...
                    LogUtils.v(this, "change minutes after hour wheeled");
                    changeMinuteData(DateUtils.trimZero(selectedHour));
...
//            LogUtils.v(this, "preSelectMonth=" + preSelectMonth);
        }
        months.clear();
...
//            LogUtils.v(this, "maxDays=" + maxDays + ", preSelectDay=" + preSelectDay);
        }
        days.clear();
