...
public final class SPUtils {
    ...
    private static final String SP_UTILS = "utils.sp";

    public static final String SP_USER = "user.sp";
    public static final String SP_TOKEN = "token";
    public static final String SP_LOGIN_USER_ID = "login_user_id";
    public static final String SP_LOGIN_FAMILY_ID = "login_family_id";
    public static final String SP_SHOW_USER_ID = "show_user_id";
    ...
    public static SPUtils getInstance(String spName, final int mode) {
        if (TextUtils.isEmpty(spName)) spName = SP_UTILS;
