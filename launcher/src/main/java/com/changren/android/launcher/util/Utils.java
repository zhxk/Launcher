...
public final class Utils {
    ...
    // add for planLine by shibo.zheng 20190220 start
    ...
    public static void toHealthPlan(Context context, String packageName, String className) {
...
//        intent.addCategory(Intent.CATEGORY_LAUNCHER);
    ...
    public static void toHealthPlan(Context context, String packageName, String className, int id) {
        ...
        ComponentName cn = new ComponentName(packageName, className);
        intent.setComponent(cn);
        intent.putExtra("infomationId", id);
        context.startActivity(intent);
    }
    // add for planLine by shibo.zheng 20190220 end
