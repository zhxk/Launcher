...
//            translateX = Math.signum(itemPositionToCenterDiff) * translateYGeneral;
//            translateY = 0;
...
//        Log.e("ItemTransformation", "scale = " +scale+" translateX = "+translateX + " translateY = "+translateY);
        return new ItemTransformation(scale, scale, translateX, translateY);
//        return new ItemTransformation(1.3f, 1.3f, translateX, translateY);
    }
}