...
//            Log.e("ItemTransformation", "left = " + Math.round(start + transformation.mTranslationX));
//            Log.e("ItemTransformation", "top = " + Math.round(top + transformation.mTranslationY));
//            Log.e("ItemTransformation", "right = " + Math.round(end + transformation.mTranslationX));
//            Log.e("ItemTransformation", "bottom = " + Math.round(bottom + transformation.mTranslationY));
