package com.changren.android.component;
...
public class BadgeView extends TextView {
	...
	private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#f54e46"); //Color.RED;
	...
	private void applyTo(View target) {
		...
		if (target instanceof TabWidget) {
			...
			//Add by wangsy start
            //ConstraintLayout布局是根据ID获取view，如果不修改container的id，则会出现LayoutParams转换异常
